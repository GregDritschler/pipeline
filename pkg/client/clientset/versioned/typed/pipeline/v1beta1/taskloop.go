...
type TaskLoopInterface interface {
	Create(*v1beta1.TaskLoop) (*v1beta1.TaskLoop, error)
	Update(*v1beta1.TaskLoop) (*v1beta1.TaskLoop, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.TaskLoop, error)
	List(opts v1.ListOptions) (*v1beta1.TaskLoopList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.TaskLoop, err error)
	TaskLoopExpansion
}
...
func newTaskLoops(c *TektonV1beta1Client, namespace string) *taskLoops {
	return &taskLoops{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *taskLoops) Get(name string, options v1.GetOptions) (result *v1beta1.TaskLoop, err error) {
	result = &v1beta1.TaskLoop{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("taskloops").
		Name(name).
...
func (c *taskLoops) List(opts v1.ListOptions) (result *v1beta1.TaskLoopList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.TaskLoopList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("taskloops").
...
func (c *taskLoops) Create(taskLoop *v1beta1.TaskLoop) (result *v1beta1.TaskLoop, err error) {
	result = &v1beta1.TaskLoop{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("taskloops").
...
func (c *taskLoops) Update(taskLoop *v1beta1.TaskLoop) (result *v1beta1.TaskLoop, err error) {
	result = &v1beta1.TaskLoop{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("taskloops").
...
func (c *taskLoops) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.TaskLoop, err error) {
	result = &v1beta1.TaskLoop{}
