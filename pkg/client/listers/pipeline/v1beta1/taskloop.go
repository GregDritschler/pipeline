...
type TaskLoopLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.TaskLoop, err error)
...
// List lists all TaskLoops in the indexer.
func (s *taskLoopLister) List(selector labels.Selector) (ret []*v1beta1.TaskLoop, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.TaskLoop))
	})
	return ret, err
}
...
type TaskLoopNamespaceLister interface {
	...
	Get(name string) (*v1beta1.TaskLoop, error)
...
// List lists all TaskLoops in the indexer for a given namespace.
func (s taskLoopNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.TaskLoop, err error) {
...
// Get retrieves the TaskLoop from the indexer for a given namespace and name.
func (s taskLoopNamespaceLister) Get(name string) (*v1beta1.TaskLoop, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("taskloop"), name)
	}
	return obj.(*v1beta1.TaskLoop), nil
}
