...
// controller reconciling v1beta1.TaskLoopRun.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1beta1.TaskLoopRun. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1beta1.TaskLoopRun) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1beta1.TaskLoopRun.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1beta1.TaskLoopRun. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1beta1.TaskLoopRun) reconciler.Event
}

// reconcilerImpl implements controller.Reconciler for v1beta1.TaskLoopRun resources.
type reconcilerImpl struct {
	// Client is used to write back status updates.
	Client versioned.Interface

	// Listers index properties about resources
	Lister pipelinev1beta1.TaskLoopRunLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister pipelinev1beta1.TaskLoopRunLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.TaskLoopRuns(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1beta1.TaskLoopRun, desired *v1beta1.TaskLoopRun) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.TektonV1beta1().TaskLoopRuns(desired.Namespace)
		...
		updater := r.Client.TektonV1beta1().TaskLoopRuns(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.TaskLoopRun) (*v1beta1.TaskLoopRun, error) {

	getter := r.Lister.TaskLoopRuns(resource.Namespace)
	...
	patcher := r.Client.TektonV1beta1().TaskLoopRuns(resource.Namespace)
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1beta1.TaskLoopRun) (*v1beta1.TaskLoopRun, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.TaskLoopRun, reconcileEvent reconciler.Event) (*v1beta1.TaskLoopRun, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
