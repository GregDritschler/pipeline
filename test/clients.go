...
type clients struct {
	...
	TaskLoopClient         v1beta1.TaskLoopInterface
	TaskLoopRunClient      v1beta1.TaskLoopRunInterface
}
...
func newClients(t *testing.T, configPath, clusterName, namespace string) *clients {
	...
	c.TaskLoopClient = cs.TektonV1beta1().TaskLoops(namespace)
	c.TaskLoopRunClient = cs.TektonV1beta1().TaskLoopRuns(namespace)
	return c
}
